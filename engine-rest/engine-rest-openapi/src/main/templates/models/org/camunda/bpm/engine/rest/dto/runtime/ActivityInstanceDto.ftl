{
  ...
  "properties": {
    ...
    <@lib.property name="activityId"
        type="string"
        description="The id of the activity."/>,
    <@lib.property name="activityName"
        type="string"
        description="The name of the activity"/>,
    <@lib.property name="activityType"
        type="string"
        description="The type of activity (corresponds to the XML element name in the BPMN 2.0, e.g., 'userTask')"/>,
    <@lib.property name="processInstanceId"
        type="string"
    ...
    <@lib.property name="executionIds"
        type="array"
        itemType='"type": "string"'
        description="A list of execution ids."/>,
    <@lib.property name="incidentIds"
        type="array"
        itemType='"type": "string"'
        description="A list of incident ids."/>,
    <@lib.property name="incidents"
        type="array"
